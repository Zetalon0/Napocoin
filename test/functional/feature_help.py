...
"""Verify that starting napocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start napocoin with -h for help text")
        ...
        self.log.info("Start napocoin with -version for version information")
        ...
        self.log.info("Start napocoind with -fakearg to make sure it does not start")
