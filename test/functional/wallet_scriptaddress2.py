...
#
# Test new Napocoin multisig prefix functionality.
#
...
class ScriptAddress2Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(multisig_addr[0], 'Z')
        ...
        priv_keys = ["cU7eeLPKzXeKMeZvnEJhvZZ3tLqVF3XGeo1BbM8dnbmV7pP3Zg89",
        ...
        assert_equal(multisig_addr_new, 'ZZ974ZrPrmqMmm1PSVp4m8YEgo3bCZZBbe')
        multisig_addr_old = "2N5nLwYz9qfnGdaFLpPn3gS6oYZbmLTWPjq"
