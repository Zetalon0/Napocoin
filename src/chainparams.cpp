...
public:
    CMainParams() {
        ...
        consensus.nMinerConfirmationWindow = 40000; // nPowTargetTimespan / nPowTargetSpacing * 4
        ...
        consensus.defaultAssumeValid = uint256S("0x677de9d88bee0d3e1a4900d2790f1f277bb229dbf4ea9baf3322965883e6616c"); //0
...
public:
    CTestNetParams() {
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 1; // 100% for testchains
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.nPowTargetTimespan = 5 * 10000; //10000 block
        consensus.nPowTargetSpacing = 5;
        ...
        consensus.nMinerConfirmationWindow = 144; // Faster than normal for regtest (144 instead of 40000)
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
