...
const char * const BITCOIN_CONF_FILENAME = "napocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Napocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Napocoin";
#else
    // Unix
    return pathRet / ".napocoin";
#endif
#endif
}
