...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " napocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  napocoin-tx [options] <hex-tx> [commands]  Update hex-encoded napocoin transaction\n" +
            "or:     napocoin-tx [options] -create [commands]   Create hex-encoded napocoin transaction\n" +
            "\n";
