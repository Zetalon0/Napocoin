...
BOOST_AUTO_TEST_CASE(get_next_work)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, 60, 60, chainParams->GetConsensus()), 0x1c093f8dU);
}
...
{
    const auto chainParams = CreateChainParams(CBaseChainParams::MAIN);
    int64_t nLastRetargetTime = 1664603434; // Block #0
    CBlockIndex pindexLast;
    pindexLast.nHeight = 2015;
    pindexLast.nTime = 1318480354;  // Block #2015
    pindexLast.nBits = 0x1e0ffff0;
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, 60, 60, chainParams->GetConsensus()), 0x1e0fffffU);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_lower_limit_actual)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, 60, 60, chainParams->GetConsensus()), 0x1b01d73cU);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_upper_limit_actual)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, 60, 60, chainParams->GetConsensus()), 0x1b054c60U);
}
