# Support for Output Descriptors in Napocoin Core

Since Napocoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `nap1...` for mainnet or `tnap1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Napocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Napocoin Core wallets, a convenience function `combo` is
